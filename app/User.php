...
class User extends Authenticatable
{
    ...
    public function is_having($itemIdOrCord)
     {
         if (is_numeric($itemIdOrCord)) {
             $item_id_exists = $this->have_items()->where('item_id', $itemIdOrCord)->exists();
             return $item_id_exists;
         } else {
             $item_code_exists = $this->have_items()->where('code', $itemIdOrCord)->exists();
             return $item_code_exists;
         }
     }
}
